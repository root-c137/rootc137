 ...
 */
final class Version20231204095337 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD section_id INT NOT NULL');
        $this->addSql('ALTER TABLE project ADD CONSTRAINT FK_2FB3D0EED823E37A FOREIGN KEY (section_id) REFERENCES section (id)');
        $this->addSql('CREATE INDEX IDX_2FB3D0EED823E37A ON project (section_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project DROP FOREIGN KEY FK_2FB3D0EED823E37A');
        $this->addSql('DROP INDEX IDX_2FB3D0EED823E37A ON project');
        $this->addSql('ALTER TABLE project DROP section_id');
    }
}
